"""
Django settings for uberapi project.
...
SECRET_KEY = 'django-insecure-e3#oa-k0n9y5&0v0yhny@u@0hnx6lz4d_mmz5%divp8dzbk#30'
...
WSGI_APPLICATION = 'uberapi.wsgi.application'
